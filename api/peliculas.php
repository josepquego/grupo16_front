...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($titulo && $genero && $duracion && $imagen) {
        ...
        $query = "INSERT INTO peliculas (idPelicula, titulo, genero, duracion, imagen) VALUES (NULL, '$titulo', '$genero', '$duracion', '$imagen')";
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
   ...
   /* if (isset($_GET['id'])) {
    ...
    if ($idParam !== null) {
        ...
        $query = "SELECT * FROM peliculas WHERE idPelicula = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    if ($idPelicula && $titulo && $genero && $duracion && $imagen) {
        ...
        $query = "UPDATE peliculas SET titulo = '$titulo', genero = '$genero', duracion = '$duracion', imagen = '$imagen' WHERE idPelicula = $idPelicula";
...
if ($_SERVER['REQUEST_METHOD'] == 'DELETE') {
    ...
    if ($idParam) {
        ...
        $query = "DELETE FROM peliculas WHERE idPelicula = $idParam";
